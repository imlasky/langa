...
<div class="flex w-full justify-center mt-24">
    <div class="flex flex-col w-full items-center">
        ...
        <h1 class="text-2xl">Register to Langa</h1>
        ...
        <form method="POST" use:enhance class="flex flex-col items-center w-1/2 gap-y-2">
            ...
            <div class="form-control w-full max-w-sm">
              ...
              <input name="passwordConfirm" type="password" placeholder="Confirm password" class="input input-bordered w-full max-w-sm" />
          </div>
          <button class="btn" on:click={handleClick}>
            ...
            <a href="/auth/login" class="underline">Have an account?</a>
        </form>
    </div>
</div>